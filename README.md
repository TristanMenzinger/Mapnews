<p align="center">
  <img src="https://raw.githubusercontent.com/TristanMenzinger/Mapnews/readme/Mapnews_logo.png?token=AG7APXVOSZMNXGCVT3AETU26YWVLG" width="20%">
</p>

## Motivation
Every day, things happen all around the world, but we rarely think about where exactly things are happening. This is why, some years ago, I first created this. I hope you like it, feel free to comment or get in touch!

#### Desktop
In the top left you can select from different providers and search. When you click on a RSS headline that interests you, you will see the RSS post and the locations mentioned in the article.
#### Mobile
Swipe through RSS headlines to discover where things are happening. Swipe up to filter and search.
...
I found this during the stay-at-home time of the coronavirus and decided to redo and release the project.
